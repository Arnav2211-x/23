...
function ScrollingDove() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Move from left (-50%) to right (50%) of screen
      const translateX = -50 + clampedProgress * 100

      // Add subtle vertical movement and rotation
      const translateY = Math.sin(clampedProgress * Math.PI) * 20
      const rotateY = clampedProgress * 360

      modelRef.current.style.transform = `translateX(${translateX}vw) translateY(${translateY}px) rotateY(${rotateY}deg)`
      modelRef.current.style.opacity = clampedProgress > 0.1 ? "0.8" : "0"
    }
  ...
  return (
    <div className="fixed top-1/2 left-0 z-20 pointer-events-none">
      <model-viewer
        ref={modelRef}
        src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/2-Nv8fIiJxiPHKTsMHS7JwQ2PKicivO1.glb"
        alt="Flying dove"
        auto-rotate
        camera-controls
        disable-zoom
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-gray-900/50 rounded-lg overflow-hidden border border-cyan-400/20">
            <img
              src="/peace-circle.png"
              alt="Community peace gathering"
          ...
          <div className="bg-gray-900/50 rounded-lg overflow-hidden border border-cyan-400/20">
            <img src="/placeholder-iilhz.png" alt="Global peace initiative" className="w-full h-48 object-cover" />
            <div className="p-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-gray-900/50 rounded-lg overflow-hidden border border-cyan-400/20">
            <iframe
              width="100%"
              height="250"
              src="https://www.youtube.com/embed/sClHKQyEgjg"
            ...
            />
            <div className="p-4">
              <h3 className="text-xl font-semibold text-white mb-2">Conflict Resolution Workshop</h3>
              <p className="text-gray-300">Practical techniques for resolving conflicts peacefully</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-900/50 rounded-lg overflow-hidden border border-cyan-400/20">
            <img src="/peaceful-meditation-session.png" alt="Mindfulness for peace" className="w-full h-32 object-cover" />
            <div className="p-3">
